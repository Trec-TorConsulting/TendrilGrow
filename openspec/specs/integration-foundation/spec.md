# integration-foundation Specification

## Purpose
The HACS-installable custom-integration skeleton: valid manifest, async
config-entry lifecycle (setup/unload/reload), per-entry runtime data, redacted
diagnostics, and secret-safe logging.
## Requirements
